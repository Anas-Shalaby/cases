    -- =============================================================================
    -- إصلاح تكرار إشعارات المنسقين
    -- المشكلة: الدالة القديمة تبعت لكل المنسقين بدل المنسق المعين على القضية
    -- الحل: أرسل للمنسق المعين أولاً، fallback لكل المنسقين لو مفيش منسق معين
    -- =============================================================================
    ...
    BEGIN
        ...
        IF v_coordinator_id IS NOT NULL THEN
            ...
            IF p_type IN ('report_deadline', 'meeting_reminder') THEN
                ...
                -- إنشاء إشعار جديد لو مفيش واحد موجود اليوم
                IF NOT EXISTS (
        ...
        -- ===== Fallback: لو القضية مش معين عليها منسق =====
        FOR v_user_id IN
    ...
    -- =============================================================================
    -- تحديث دالة مزامنة الإشعارات لإضافة نواقص مراحل ما قبل الاجتماع
    -- =============================================================================

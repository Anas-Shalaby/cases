...
const CASE_DATE_FIELDS =
  "case_number, case_name, status, assignment_date, meeting_date, initial_report_date, final_report_date, case_received_at, parties_invited_at, experts_meeting_at, documents_submission_deadline_at, initial_report_feedback_deadline_at, initial_report_prepared_at, final_report_prepared_at, case_closed_at";
